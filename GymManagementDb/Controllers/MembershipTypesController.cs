...
namespace GymManagementDb.Controllers
{
    public class MembershipTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MembershipTypeID,Name,Price,Duration")] MembershipType membershipType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MembershipTypeID,Name,Price,Duration")] MembershipType membershipType)
        {
