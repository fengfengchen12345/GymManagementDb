...
namespace GymManagementDb.Controllers
{
    public class TrainersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TrainerID,Name,YearsOfExperience")] Trainers trainers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TrainerID,Name,YearsOfExperience")] Trainers trainers)
        {
