    ...
    public static class DummyData
    {
        public static void AddData(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                {
                new Trainers { Name = "Jane Smith", YearsOfExperience = 6, TrainerSpecialtyID = 1},
                new Trainers { Name = "John Doe", YearsOfExperience = 5, TrainerSpecialtyID = 2},
                new Trainers { Name = "Chris Johnson", YearsOfExperience = 7, TrainerSpecialtyID = 3},
                new Trainers { Name = "Emily Davis", YearsOfExperience = 8, TrainerID=5, TrainerSpecialtyID = 4},
                new Trainers { Name = "Michael Brown", YearsOfExperience = 9, TrainerSpecialtyID = 5},
                new Trainers { Name = "Sara Wilson", YearsOfExperience = 10, TrainerSpecialtyID = 6},
                new Trainers { Name = "David Lee", YearsOfExperience = 11,TrainerSpecialtyID = 1 },
                new Trainers { Name = "Rachel Green", YearsOfExperience = 12, TrainerSpecialtyID = 2},
                new Trainers { Name = "Daniel Harris", YearsOfExperience = 13, TrainerSpecialtyID = 3},
                new Trainers { Name = "Olivia Martinez", YearsOfExperience = 14, TrainerSpecialtyID = 4},
                new Trainers { Name = "James Clark", YearsOfExperience = 15, TrainerSpecialtyID = 5},
                new Trainers { Name = "Sophia Lopez", YearsOfExperience = 16, TrainerSpecialtyID = 1},
                new Trainers { Name = "Ethan Walker", YearsOfExperience = 17, TrainerSpecialtyID = 2},
                new Trainers { Name = "Megan Lewis", YearsOfExperience = 18, TrainerSpecialtyID = 3},
                new Trainers { Name = "Liam Scott", YearsOfExperience = 19, TrainerSpecialtyID = 4},
                new Trainers { Name = "Ava Young", YearsOfExperience = 20, TrainerSpecialtyID = 5},
                new Trainers { Name = "Lucas Adams", YearsOfExperience = 21, TrainerSpecialtyID = 1},
                new Trainers { Name = "Charlotte Baker", YearsOfExperience = 22, TrainerSpecialtyID = 2},
                new Trainers { Name = "Jack Evans", YearsOfExperience = 23, TrainerSpecialtyID = 3}
                };
                ...
                {
                new MembershipType { Name = "Basic", Price = 29.99m, Duration = 1 },
                new MembershipType { Name = "Premium", Price = 49.99m, Duration = 1 },
                new MembershipType { Name = "VIP", Price = 99.99m, Duration = 1 },
                new MembershipType { Name = "Basic", Price = 149.99m, Duration = 6 },
                new MembershipType { Name = "Premium", Price = 249.99m, Duration = 6 },
                new MembershipType { Name  = "VIP", Price = 499.99m, Duration = 6 },
                new MembershipType { Name  = "Basic", Price = 499.99m, Duration = 12 },
                new MembershipType { Name = "Premium", Price = 799.99m, Duration = 12 },
                new MembershipType { Name = "VIP", Price = 1499.99m, Duration = 12 }
                };
